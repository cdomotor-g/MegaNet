...
│
│   Radio-path maps shown in the Network Maps tab (keep exact filenames)
├── *.pdf / *.jpg           ← regional path maps (Barron, Burdekin, Lockyer, …)
├── QldBasin_2009Nov_reduced.svg  ← Queensland drainage-basin geometry
│
